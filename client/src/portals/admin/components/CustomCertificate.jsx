        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-12 py-8">
          <div className="text-center space-y-1 w-full">
            ...
            <div className="mb-1">
              <div className="relative inline-block">
                <span
                  className="text-[42px] font-bold text-[#243d5c]"
            ...
            {/* Main Title */}
            <h1
              className="text-[68px] font-bold text-[#243d5c] tracking-[0.15em] leading-none"
              style={{ fontFamily: 'Georgia, serif' }}
            >
              CERTIFICATE
            </h1>
            ...
            <h2
              className="text-[20px] font-medium text-[#243d5c] tracking-[0.35em] mb-8"
              style={{ fontFamily: 'Georgia, serif' }}
            >
              OF ACHIEVEMENT
            </h2>
            ...
            {/* Name - DYNAMIC */}
            <h3
              className="text-[52px] text-[#d4a574] py-3"
          ...
          <div className="flex justify-between w-full mt-10">
            ...
            <div className="text-right max-w-[220px]">
              ...
              {/* CEO Title */}
              <p className="text-[11px] text-[#243d5c] mt-1">{ceoTitle}</p>
            </div>
          </div>
        </div>
      </div>
