...
const StudentLoginPage = () => {
  ...
  const [loginMethod, setLoginMethod] = useState('lms'); // 'lms' or 'email'
  ...
  const handleOAuthLogin = provider => {
    ...
    window.open(`${apiUrl}/auth/${provider}`, '_self');
  };
    ...
    <div className="container mx-auto h-screen bg-black flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-8 shadow-2xl">
          {/* Login Method Toggle */}
          <div className="flex gap-2 p-1 bg-zinc-900 rounded-xl mb-6">
            <button
              type="button"
              onClick={() => {
                setLoginMethod('lms');
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-2 py-3 px-4 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
            >
