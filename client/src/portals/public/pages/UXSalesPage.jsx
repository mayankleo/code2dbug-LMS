...
const UX = () => {
  ...
  // --- UPDATED DATA FOR UI/UX ROADMAP ---
  const courseDetails = {
    title: 'UI/UX Design Self-Paced Internship',
    subtitle:
      'A comprehensive 30-Day Roadmap. Master Design Thinking, Figma, Wireframing, and Prototyping to build user-centric digital products.',
  ...
  const learningPoints = [
    'Design Thinking & User Research Strategy',
    'Information Architecture & Wireframing',
    'Visual Design Principles (Color, Typography, Grids)',
    'Figma Mastery (Auto Layout, Components, Variants)',
    'Interactive Prototyping & Smart Animate',
    'Usability Testing & Accessibility Standards (WCAG)',
    'Portfolio Building & Case Study Structure',
  ];

  // 30-Day UI/UX Design Roadmap Data - SIMPLIFIED FORMAT
  const curriculum = [
    {
      id: 1,
      title: 'Module 1: UX Fundamentals & Research',
      timeline: 'Days 1-5',
      topics: [
        'The Design Thinking Process (Empathize, Define, Ideate)',
        'User Research Methods & Interviewing',
        'Creating User Personas & Empathy Maps',
        'Identifying User Pain Points',
      ],
      practice:
        'Persona Creation: Interview a friend about a daily habit (e.g., hydration). Create a User Persona PDF (Name, Age, Frustrations, Goals) based on that interview.',
    },
    {
      id: 2,
      ...
      topics: [
        ...
        'Low-Fidelity Wireframing (Paper Sketches)',
        'Transitioning from Low-Fi to Mid-Fi',
      ],
      practice:
        "Crazy 8s: Fold a paper into 8 sections. Spend 8 minutes sketching 8 different layout ideas for a 'Mobile Login Screen'. Pick the best one and refine it.",
    },
    {
      id: 3,
      title: 'Module 3: Visual Design (UI Principles)',
      timeline: 'Days 11-15',
      topics: [
        'Typography Hierarchy & Pairing',
        'Color Theory & Contrast Ratios (WCAG)',
        'The 8-Point Grid System & Spacing',
        'Using Whitespace effectively',
      ],
      practice:
        'Moodboard & Style Guide: Create a one-page Style Guide in Figma including Primary/Secondary Colors, Typography Scale, and Button Styles (Default, Hover, Disabled).',
    },
    {
      id: 4,
      title: 'Module 4: Figma Mastery & Components',
      timeline: 'Days 16-20',
      topics: [
        'Figma Interface & Shortcuts',
        'Auto Layout (Padding, Resizing constraints)',
        'Atomic Design: Components & Variants',
        'Responsive Design Techniques',
      ],
      practice:
        "Responsive Card: Design a 'Product Card' (Image, Title, Price, Button) using Auto Layout. Duplicate it 3 times and ensure updates to the Main Component reflect on all instances.",
    },
    {
      id: 5,
      title: 'Module 5: Prototyping & Usability',
      timeline: 'Days 21-25',
      topics: [
        'Interaction Design Basics',
        'Figma Prototyping: Connections & Flows',
        'Smart Animate & Micro-interactions',
        'Conducting Usability Testing',
      ],
      practice:
        "Interactive Prototype: Connect 3 screens (Login -> Home -> Settings). Use 'Smart Animate' to create a smooth transition when opening a menu or clicking a button.",
    },
    {
      id: 6,
      title: 'Module 6: Capstone Project & Portfolio',
      timeline: 'Days 26-30',
      topics: [
        'Structuring a Design Case Study',
        'Problem Statement to Final Solution storytelling',
        'Portfolio Building (Behance/Notion)',
        'Final Polish & Presentation',
      ],
      practice:
        'Final Deliverable: Complete a full project (Food Delivery, Pet Adoption, etc.). Create a Case Study PDF covering Research, Sketches, and Hi-Fi Screens. Publish to Behance.',
    },
  ];
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-2xl">
                ...
                <p className="text-zinc-300 leading-relaxed">
                  You only pay <strong>10% ({courseDetails.price})</strong> now to enroll and start
                  the internship. The course content itself is a curated roadmap of high-quality,
                  freely available resources. We do not charge for the content.
                  <br />
                  <br />
                  The fee covers our{' '}
                  <strong>
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-zinc-400 mb-4">
                  <span>30-Day Plan • 6 Modules</span>
                </div>
                        ...
                        <div className="bg-black/50 border-t border-zinc-800 divide-y divide-zinc-800/50">
                          ...
                          <div className="p-5 bg-blue-900/5">
                            <h4 className="text-xs font-bold text-green-400 uppercase tracking-wider mb-2 flex items-center gap-2">
                              <PenTool size={14} /> Hands-on Practice
                            </h4>
