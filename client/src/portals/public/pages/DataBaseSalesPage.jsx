...
const DataBase = () => {
  ...
  // --- UPDATED DATA FOR DATABASE ROADMAP ---
  const courseDetails = {
    title: 'Database Management Self-Paced Internship',
    subtitle:
      'A comprehensive 30-Day Roadmap mastering both SQL and NoSQL. From complex Joins to Aggregation Pipelines, become a Database expert.',
  ...
  const learningPoints = [
    ...
    'Database Modeling: Schemas vs Schemaless',
    'Performance Optimization (Indexing, Query Planning)',
    'Aggregation Frameworks & Data Analysis',
    'ACID Transactions & Data Integrity',
  ];

  // 30-Day Database Roadmap Data
  const curriculum = [
    {
      id: 1,
      title: 'Module 1: SQL Foundations (Structure & Data)',
      timeline: 'Days 1-5',
      topics: [
        'RDBMS Concepts: Tables, Rows, Columns, Keys',
        'DDL Commands: CREATE, ALTER, DROP',
        'DML Operations: INSERT, UPDATE, DELETE',
        'Basic Querying: SELECT, WHERE, JOIN Types (Inner, Left, Right)',
      ],
      practice:
        "The Bookstore DB: Create tables 'authors' and 'books'. Insert sample data. Write a JOIN query to display Book Titles alongside their Author Names.",
    },
    {
      id: 2,
      title: 'Module 2: Data Analysis (Grouping & Logic)',
      timeline: 'Days 6-9',
      topics: [
        'Aggregate Functions: COUNT, SUM, AVG, MAX/MIN',
        'Grouping Data: GROUP BY & HAVING Clause',
        'Subqueries: Nested Select statements',
        'CTEs (Common Table Expressions) for readability',
      ],
      practice:
        "Revenue Analysis: Add an 'orders' table. Use GROUP BY to calculate Total Revenue per Author. Use a CTE to filter and show only authors who earned > $100.",
    },
    {
      id: 3,
      title: 'Module 3: Advanced SQL (Optimization & Architecture)',
      timeline: 'Days 10-14',
      topics: [
      ...
      practice:
        'Rank The Sales: Write a query using RANK() to find the top 2 most expensive books within each genre. Create a View for this query for easy reuse.',
    },
    {
      id: 4,
      title: 'Module 4: MongoDB Foundations (NoSQL)',
      timeline: 'Days 15-18',
      topics: [
        'SQL vs NoSQL: Documents vs Tables',
        'BSON Data Format & Collections',
        'Schema Design: Embedding vs Referencing',
        'MongoDB Atlas Setup & Connection',
      ],
      practice:
        "NoSQL Bookstore: Create a 'Library' database in MongoDB. Insert book documents that utilize Embedded Documents for 'author' details and Arrays for 'tags'.",
    },
    {
      id: 5,
      title: 'Module 5: MongoDB Operations & Aggregation',
      timeline: 'Days 19-22',
      topics: [
        'CRUD in MongoDB (insertOne, updateMany, deleteOne)',
        'Query Operators ($gt, $in, $or)',
        'The Aggregation Pipeline ($match, $group, $project)',
        'Data Validation Rules',
      ],
      practice:
        "Inventory Report: Use the Aggregation Pipeline to calculate the total stock value per category from an 'inventory' collection. Sort results by highest value.",
    },
    {
      id: 6,
      title: 'Module 6: Database Design & Modeling',
      timeline: 'Days 23-25',
      topics: [
        'ER Diagrams & Modeling Relationships (1:1, 1:N, M:N)',
        'Normalization (1NF, 2NF, 3NF) to reduce redundancy',
        'Denormalization strategies for NoSQL',
        'ACID Transactions in SQL vs MongoDB',
      ],
      practice:
        "Schema Architect: Design the schema for a 'Social Media App' (Users, Posts, Comments) for both a SQL DB (relational) and MongoDB (document-based). Compare the structures.",
    },
    {
      id: 7,
      title: 'Module 7: Performance & Security',
      timeline: 'Days 26-28',
      topics: [
        'Query Optimization & EXPLAIN plans',
        'Creating Indexes to speed up reads',
        'Database Users, Roles & Permissions',
        'Backup & Restore strategies',
      ],
      practice:
        'Slow Query Fix: Insert 10,000 dummy records. Run a search query and measure time. Create an Index on the search field and measure the performance improvement.',
    },
    {
      id: 8,
      ...
      topics: [
        ...
        'Writing Complex Stored Procedures/Scripts',
        'Data Migration/Import',
        'Documentation (ERD + API reference)',
      ],
      practice:
        'Final Deliverable: Build the complete backend database for an E-commerce Platform. Implement Tables/Collections for Users, Products, Orders, and Reviews. Include detailed documentation of your schema.',
    },
  ];
