...
const Github = () => {
  ...
  const courseDetails = {
    ...
    subtitle:
      'A comprehensive 30-Day Roadmap. Master Git commands, GitHub collaboration, CI/CD workflows, and branching strategies to become DevOps-ready.',
  ...
  const curriculum = [
    {
      ...
      practice:
        'Mini Project: Create a local repo with multiple branches. Simulate a merge conflict and resolve it manually. Write a clean commit history.',
    },
    {
      id: 2,
      ...
      practice:
        'Collaboration Sim: Fork a public repo, create a feature branch, submit a PR, and organize tasks using a GitHub Project Board.',
    },
    {
      id: 3,
      ...
      practice:
        'History Cleanup: Take a messy repo, rebase branches, squash commits into atomic units, tag a v1.0 release, and sign your commits.',
    },
    {
      id: 4,
      ...
      practice:
        'Final Capstone: Build a complete repo with Git Flow, automated CI/CD pipelines using Actions, and deploy a portfolio site via GitHub Pages.',
    },
  ];
            ...
            <div className="lg:col-span-1 relative">
              <div className="sticky top-24 bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/10">
                <div className="p-6">
                  ...
                  <p className="text-green-400 font-bold text-sm mb-6">
                    Pay just 10% to Start Learning
                  </p>
