...
const DataAnalytics = () => {
  ...
  const courseDetails = {
    title: 'Data Analytics Self-Paced Internship',
    subtitle:
      'A comprehensive 30-Day Roadmap. Master Excel, SQL, Power BI, and Python to transform raw data into actionable business insights.',
  ...
  const learningPoints = [
    ...
    'Building Interactive Reports & Storytelling',
  ];

  // 30-Day Data Analytics Roadmap Data - SIMPLIFIED FORMAT
  const curriculum = [
    {
      id: 1,
      title: 'Module 1: Excel Foundations & Data Cleaning',
      timeline: 'Days 1-5',
      topics: [
        'Essential Formulas: VLOOKUP, XLOOKUP, SUMIF',
        'Pivot Tables & Slicers for Analysis',
        'Data Cleaning Techniques (Remove Duplicates)',
        'Building Basic Dashboards in Excel',
      ],
      practice:
        "Sales Dashboard: Clean a sample sales dataset. Create a Dashboard with 3 Pivot Charts (Region, Products, Trend) controlled by a 'Year' Slicer.",
    },
    {
      id: 2,
      title: 'Module 2: Statistics for Analytics',
      timeline: 'Days 6-7',
      topics: [
      ...
      practice:
        'Statistical Summary: Calculate Mean, Median, and Std Dev for a revenue column. Identify outliers using the Z-Score method (> 3 standard deviations).',
    },
    {
      id: 3,
      title: 'Module 3: SQL Basics (Querying Data)',
      timeline: 'Days 8-10',
      topics: [
      ...
      practice:
        'The 3-Table Join: Write a query joining Customers, Orders, and OrderDetails tables to calculate the Total Revenue generated by each Customer.',
    },
    {
      id: 4,
      title: 'Module 4: Advanced SQL (Analysis)',
      timeline: 'Days 11-14',
      topics: [
      ...
      practice:
        'Ranking Analysis: Write a SQL query using RANK() OVER (PARTITION BY ...) to identify the top 2 highest-paid employees within each department.',
    },
    {
      id: 5,
      title: 'Module 5: Power BI / Tableau (Visual Storytelling)',
      timeline: 'Days 15-21',
      topics: [
        'Data Modeling & Star Schema Concepts',
        'DAX (Data Analysis Expressions) Basics',
        'Creating Interactive Visualizations (Maps, KPIs)',
        'Publishing Reports to the Web',
      ],
      practice:
        'Interactive Report: Import SQL results into Power BI. Create Measures for Total Sales and YoY Growth. Build a dashboard with a Map, Bar Chart, and Cards.',
    },
    {
      id: 6,
      title: 'Module 6: Python for Analytics',
      timeline: 'Days 22-25',
      topics: [
      ...
      practice:
        'Titanic EDA: Load the Titanic dataset using Pandas. Generate descriptive statistics and create a Bar Plot showing survival rates by Class and Gender.',
    },
    {
      id: 7,
      title: 'Module 7: The Capstone & Portfolio',
      timeline: 'Days 26-30',
      topics: [
      ...
      practice:
        'Final Deliverable: Build a complete project (e.g., E-Commerce Sales Analysis, HR Attrition Dashboard). Submit GitHub Repo and a Portfolio Link.',
    },
  ];
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-zinc-400 mb-4">
                  <span>30-Day Plan • 7 Modules</span>
                </div>
                        ...
                        <div className="bg-black/50 border-t border-zinc-800 divide-y divide-zinc-800/50">
                          ...
                          <div className="p-5 bg-blue-900/5">
                            <h4 className="text-xs font-bold text-green-400 uppercase tracking-wider mb-2 flex items-center gap-2">
                              <BarChart size={14} /> Hands-on Practice
                            </h4>
