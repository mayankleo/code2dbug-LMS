...
const MobileDev = () => {
  ...
  const courseDetails = {
    ...
    subtitle:
      'A comprehensive 30-Day Roadmap. Master Dart, Flutter, Firebase, and State Management to build beautiful, native-compiled mobile apps.',
  ...
  const curriculum = [
    {
      ...
      practice:
        'CLI Expense Calculator: Write a Dart script that takes income/expenses via command line, calculates the balance, and prints custom feedback messages.',
    },
    {
      id: 2,
      ...
      practice:
        'Digital Business Card: Create a static UI featuring your circular avatar, Name, Job Title, and a row of contact icons (Phone, Email, LinkedIn).',
    },
    {
      id: 3,
      ...
      practice:
        'Responsive Dashboard: Build a grid view that shows 1 column on mobile devices (width < 600) and adapts to 3 columns on tablet/web (width > 600).',
    },
    {
      id: 4,
      ...
      practice:
        'Shopping List App: Build a multi-screen app. Add items via a form on Screen 2 and see them appear instantly on Screen 1 using Provider.',
    },
    {
      id: 5,
      ...
      practice:
        "Crypto Price Tracker: Fetch live coin data from a public API (e.g., CoinGecko). Display a list of coins with prices and a 'Refresh' button.",
    },
    {
      id: 6,
      ...
      practice:
        'Real-time Chat MVP: Create a chat room where users can login anonymously and send messages that appear instantly on all devices via Firestore Streams.',
    },
    {
      id: 7,
      ...
      practice:
        'Camera & Gallery App: Build an app that requests camera permissions, captures a photo, and displays the captured image on the screen.',
    },
    {
      id: 8,
      ...
      practice:
        'Final Deliverable: Build a complete app (Food Delivery, Social Media, Habit Tracker, etc.) with Auth & DB. Submit GitHub Repo + Release APK + Screenshots.',
    },
  ];
