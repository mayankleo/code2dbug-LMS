...
const FrontEnd = () => {
  ...
  const courseDetails = {
    ...
    subtitle:
      'A highly structured, intensive 30-Day Roadmap. Master HTML, CSS, Tailwind, JavaScript, TypeScript, and React to build modern UIs.',
  ...
  const curriculum = [
    {
      ...
      practice:
        'Multi-Page Portfolio: Build a 3-page static site (Home, About, Contact). The Contact page must have a form with validation attributes. Push code to GitHub.',
    },
    {
      id: 2,
      ...
      practice:
        'Responsive Landing Page: Clone a simple homepage (e.g., Dropbox). Create a Navbar that switches from horizontal links to a hamburger menu on mobile.',
    },
    {
      id: 3,
      ...
      practice:
        "Spotify UI Card: Create a 'Now Playing' card component using only Tailwind classes. Include album art, song details, and playback controls with Dark Mode support.",
    },
    {
      id: 4,
      ...
      practice:
        'Dynamic Todo App: Build a functional Todo list where users can Add, Delete, and Mark tasks as Complete. Persist data using localStorage.',
    },
    {
      id: 5,
      ...
      practice:
        'Typed Weather App: Build a weather dashboard that fetches data from a public API. Use TypeScript interfaces to define the structure of the API response.',
    },
    {
      id: 6,
      ...
      practice:
        'Image Gallery: Create a React app that fetches images from an API (like Unsplash). Use useState for the image list and useEffect for the initial fetch.',
    },
    {
      id: 7,
      ...
      practice:
        'E-Commerce Cart: Build a mini-store with Product and Cart pages. Use Context API to manage the cart state so items persist when navigating between pages.',
    },
    {
      id: 8,
      ...
      practice:
        'Final Build: Choose one major project (Netflix Clone, Crypto Dashboard, Kanban Board, etc.) and deploy it live. Submit the live URL and GitHub Repo.',
    },
  ];
