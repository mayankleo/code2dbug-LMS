...
const BackEnd = () => {
  ...
  const courseDetails = {
    ...
    subtitle:
      'A highly structured, intensive 30-Day Roadmap. Master Node.js, Express, MongoDB, System Design, and DevOps to build scalable APIs.',
  ...
  const curriculum = [
    {
      ...
      practice:
        'Network Inspector: Use Chrome DevTools Network Tab to analyze requests. Identify a GET request (page load) and a POST request (form submit). Document Headers and Payload.',
    },
    {
      id: 2,
      ...
      practice:
        'CLI File Manager: Write a Node.js script (no Express) that creates a folder, writes a file inside it with text, and reads the content back to the console.',
    },
    {
      id: 3,
      ...
      practice:
        "Basic CRUD API: Build a 'TaskManager' API using Express with endpoints to GET, POST, and DELETE tasks. Store data in a local array variable for now.",
    },
    {
      id: 4,
      ...
      practice:
        "Database Integration: Connect your 'TaskManager' API to MongoDB Atlas. Replace the local array storage with actual Mongoose queries (find, create, deleteOne).",
    },
    {
      id: 5,
      ...
      practice:
        'Auth System: Implement /register and /login routes. Hash passwords before saving. Create middleware to block access to /tasks unless a valid JWT is provided.',
    },
    {
      id: 6,
      ...
      practice:
        'Refactor to MVC: Reorganize your Task Manager code into /models, /controllers, and /routes folders. Use a .env file to secure your MongoDB URI.',
    },
    {
      id: 7,
      ...
      practice:
        'Go Live: Deploy your Task Manager API to a free hosting service like Render or Railway. Test the live public URL using Postman.',
    },
    {
      id: 8,
      ...
      practice:
        'Final Deliverable: Build a complete Backend System (URL Shortener, Blog API, E-commerce Backend, etc.) with Auth and DB. Submit the Live URL and GitHub Repo.',
    },
  ];
