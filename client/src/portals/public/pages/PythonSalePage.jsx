...
const Python = () => {
  ...
  const courseDetails = {
    ...
    subtitle:
      'A highly structured, intensive 30-Day Roadmap. Master Python, Django, DRF, and Flask to build powerful, scalable backend systems.',
  ...
  const curriculum = [
    {
      ...
      practice:
        'Student Record System (CLI): Create a program using a List of Dictionaries to add, remove, and find students (Name, Age, Grade).',
    },
    {
      id: 2,
      ...
      practice:
        'Library Management System (OOP): Create Book and Library classes with borrow/return methods. Save data to a text file for persistence.',
    },
    {
      id: 3,
      ...
      practice:
        'Multi-Page Website: Create a Django project with Home, About, and Contact pages. Use Template Inheritance for a consistent Navbar.',
    },
    {
      id: 4,
      ...
      practice:
        'Blog CRUD: Build a UI to View, Create, Update, and Delete blog posts using Django Models and Forms.',
    },
    {
      id: 5,
      ...
      practice:
        'Blog API: Convert the Blog project into a REST API. Protect Create/Update routes with JWT Authentication. Test using Postman.',
    },
    {
      id: 6,
      ...
      practice:
        'Note Taking API (Flask): Build a simple API with SQLite database to GET and POST notes using Flask and SQLAlchemy.',
    },
    {
      id: 7,
      ...
      practice:
        'Go Live: Deploy the Django Blog API to Render. Configure WhiteNoise for static files and connect a live PostgreSQL database.',
    },
    {
      id: 8,
      ...
      practice:
        'Final Deliverable: Build a complete backend (E-Commerce, Social Media, or LMS). Include Auth, DB, and Documentation. Submit Live URL + GitHub Repo.',
    },
  ];
